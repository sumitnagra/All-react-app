  ...
  return (<>
    <div className="cartItem " data-aos="fade-up">
      ...
      <div >
        ...
        <div className="my-2" ><b>Quantity:<span><button className="btn btn-warning btn-sm mx-2" onClick={decrement} style={{ fontSize: "20px" }}> - </button><b><input type="text" value={quanity} onChange={(e)=>setQuanity(Number(e.target.value))} className="btn btn-sm" style={{width:"15%",fontWeight:"bold",color:"black"}}/></b></span><button className="btn btn-warning btn-sm mx-2" onClick={increment} style={{ fontSize: "20px" }}> + </button></b></div>
        ...
        <span className="btn btn-warning button">Buy Now</span>
      </div>
    </div>
