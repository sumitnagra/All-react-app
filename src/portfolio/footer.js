    ...
    return (<>
        <div>
            ...
            <div className='footer'>
                ...
                <div className="follow">Follow Me<div><a href="https://www.linkedin.com/in/sumit-kumar-463bb424a/" target="_blank" rel="noreferrer"><i className="fa-brands fa-linkedin-in" style={{ cursor: "pointer", color: `${location.pathname === "/resume" ? "black" : "white"}` }}></i></a><a href='https://github.com/sumitnagra' target='_blank'  rel="noreferrer"><i className="fa-brands fa-github" style={{ cursor: "pointer", color: `${location.pathname === "/resume"? "black" : "white"}` }}></i> </a></div></div>
