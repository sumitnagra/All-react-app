...
<hr  style={{top:"15rem" }}/>
        <div className='footer'>
            ...
            <div className="follow">Follow Me<div><a href="https://www.linkedin.com/in/sumit-kumar-463bb424a/" target="_blank"  rel="noreferrer"><i className="fa-brands fa-linkedin-in"  style={{cursor:"pointer",color:"black"}}></i></a></div></div>
