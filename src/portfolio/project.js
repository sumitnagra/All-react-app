...
<p> This small application help user to create a todo list of the day ,the user can add task ,delete task and capbble in modify the existed task  </p><button className='btn btn-dark' onClick={()=>{navigate("/app")}}>Try It</button></div><img src={Project6} width={500} height={300} style={{boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px"}}/>
</div>
</div>
<Footer/>
    </>)
