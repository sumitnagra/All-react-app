...
<p className='projectDescription'> This small application help user to create a todo list of the day ,the user can add task ,delete task and capable in modify the existed task  </p><button className='btn btn-dark' onClick={()=>{navigate("/app");window.scrollTo(0,110);document.title="Todo list"}}>Try It</button></div><img src={Project6} />
</div>
<div className='firstProject ' data-aos="fade-up">
    <div className='textsection' ><h2>08 Shoping Cart </h2>
<p className='projectDescription'> The smart add to cart application in which you can choose different product from the list and buy whenever you want also you can remove the product from the list , great simple user interface . See the full details of the product after add to cart   </p><button className='btn btn-dark' onClick={()=>{navigate("/shop");window.scrollTo(0,110);document.title="Shoping cart"}}>Try It</button></div><img src={Project8}/>
</div>
<div className='firstProject ' data-aos="fade-up">
    <div className='textsection' ><h2>09 Text to speech</h2>
<p className='projectDescription'> A cutting-edge text-to-speech app built with React! With a sleek interface and powerful functionality, it transforms written text into clear, natural-sounding audio.Having different kind of voices from different counteries. Experience the fusion of technology and creativity as words come to life. Discover the power of communication through my innovative TTS app. </p><button className='btn btn-dark' onClick={()=>{navigate("/speech");window.scrollTo(0,110);document.title="Text To Speech "}}>Try It</button></div><img src={Project9}/>
</div>
<Footer/>
    </>)
}
