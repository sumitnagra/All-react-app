...
<div className='firstProject padding' data-aos="fade-up"> 
     ...
     <div className="expertise">
      <ul>
        <li><i className="fa-brands fa-html5 fa-xl"></i> Html</li>
        <li ><i className="fa-brands fa-css3-alt fa-xl" ></i> Css</li>
        <li><i className="fa-brands fa-square-js fa-xl"></i> Javascript</li>
        <li><i className="fa-brands fa-bootstrap fa-xl"></i> Bootsrap</li>
        <li><img height={25} src={jquery}/> Jquery</li>
        <li><i className="fa-brands fa-react fa-xl"></i> React</li>
        <li><img height={25} src={redux}/> Redux</li>
        <li><i className="fa-brands fa-node-js fa-xl"></i> Node js</li>
        <li><img height={25} src={express}/> Express js</li>
        <li><img src={mongodb} height={25}/> Mongodb</li>
        <li><img src={sql} height={25}/> Sql</li>
        <li> <i className="fa-brands fa-sass fa-xl"></i> Sass</li>
        <li> <i className="fa-brands fa-npm fa-xl"></i> Npm</li>
      </ul>
   </div>
</div>
</div>
